          ...
          {products.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map((prod: any) => (
                ...
                >
                  {/* Card Image */}
                  <div className="relative h-52 bg-navy-950 overflow-hidden">
                    {prod.images?.[0]?.url ? (
                      <div
                    ...
                    {prod.authorisedDealer && (
                      <div className="absolute top-3.5 left-3.5 bg-red-600 text-white text-xs font-bold uppercase tracking-wider px-3 py-1.5 rounded-lg shadow flex items-center gap-1.5">
                        <ShieldCheck className="w-4 h-4 text-gold-400" />
                        Authorised Dealer
                      </div>
                    )}

                    <div className="absolute bottom-3.5 right-3.5 bg-navy-900/90 text-gold-400 text-xs font-bold px-2.5 py-1 rounded-md border border-navy-700">
                      {prod.brand}
                    </div>
                  </div>
                    ...
                    <div className="pt-3.5 border-t border-gray-100 flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Link
                          ...
                          className="bg-navy-900 text-gold-400 text-xs font-bold px-3 py-2 rounded-lg hover:bg-red-600 hover:text-white transition-colors"
                        >
                          Inquire Price
                        </Link>
                      </div>
